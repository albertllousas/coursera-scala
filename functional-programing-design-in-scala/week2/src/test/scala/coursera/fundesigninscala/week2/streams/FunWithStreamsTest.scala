package coursera.fundesigninscala.week2.streams
...
class FunWithStreamsTest extends FunSuite with Matchers {
  ...
  // TODO: this class could be totally improved, but for now works in some cases at test
  ...
  test("stream creation recursive method should be 'n+1' times when resulting stream is accessed at index n") {
